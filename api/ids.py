...
def login(studentid:str, password:str) -> requests.Session | None:
...
def get_info(session:requests.Session) -> dict | None:
    url = r"https://ids.shanghaitech.edu.cn/personalInfo/common/getUserConf"
